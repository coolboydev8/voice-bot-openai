...
const StyledForm = styled(Form)`
  & :where(.css-dev-only-do-not-override-1r287do).ant-input-outlined.ant-input-status-error:not(.ant-input-disabled){
    background: #9d366a6e;
    border:none;
    border-bottom: solid 3px;
    border-bottom-color: #ff4040;
  }
  & :where(.css-dev-only-do-not-override-1r287do).ant-form-item .ant-form-item-explain-error{
      color: #ff4d4f;
    text-align: left;
    font-size: 18px;
  }
  ...
  return (
    <div className="login_div">
      <Col style={{ width: '90%' }}>
        ...
        <h4 style={{ paddingBottom: '18px', fontWeight: '400', paddingTop: '0px', marginTop: '0px', fontSize: '16px', fontWeight: '500', color: '#7d8995' }}>Please sign in to your account</h4>
        <StyledForm
